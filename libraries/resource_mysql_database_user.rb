...
require File.join(File.dirname(__FILE__), 'resource_mysql_database')
require File.join(File.dirname(__FILE__), 'provider_mysql_database_user')

class Chef
  class Resource
    class MysqlDatabaseUser < Chef::Resource::MysqlDatabase
      def initialize(name, run_context = nil)
        ...
        @action = :create
        @provider = Chef::Provider::MysqlDatabase::User
